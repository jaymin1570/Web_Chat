...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 font-weight-normal">My Chat...</h1>
            <p class="lead font-weight-normal">Chat with me without worrying about the chat logs. Now you can chat with me using my free platform.</p>
            <form action="claim.php" method="post" class="form-inline">
                <div class="form-group">
                    Jamu1570Chat.com/<input class="form-control mr-2 ml-1" type="text" name="room">
